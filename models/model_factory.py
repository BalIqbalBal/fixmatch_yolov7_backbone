...
from models.yolo_backbone import Backbone, RepConv, Conv
...
def get_yolo(num_classes, pretrained=False, phi='l'):

    # YOLOv7 Default Config 
    transition_channels = {'l': 32, 'x': 40}[phi]
    block_channels = 32
    n = {'l': 4, 'x': 6}[phi]

    return Backbone(num_classes=num_classes, transition_channels=transition_channels, block_channels=block_channels, n=n, phi=phi, pretrained=False)
